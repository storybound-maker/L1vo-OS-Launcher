...
@Composable fun L1voLauncherApp(){
 ...
 val font=when(p.getString(FONT,"Sans")){"Serif"->FontFamily.Serif;"Mono"->FontFamily.Monospace;else->FontFamily.SansSerif}; val ink=rememberAdaptiveInk(wallpaper,dark)
